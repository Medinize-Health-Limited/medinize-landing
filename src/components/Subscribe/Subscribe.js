...
const Subscribe = () => {
    ...
    return (
        <div className="subscribe mt-28 py-[4.2rem]">
            ...
            <p className="text-center text-[#ffffffc9] flex md:w-[35%] w-[90%] mx-auto mt-5 md:leading-[30px] leading-[27px] text-[14.5px]">
            ...
            <form className="md:flex md:flex-row md:justify-between md:items-center md:w-[45%] w-[85%] md:space-y-0 space-y-6 mx-auto mt-6 md:space-x-8">
                ...
                <button className="w-full md:w-[30%] bg-[#358E07] text-white md:rounded-[.4rem] rounded-full px-8 md:py-[.6rem] py-[.8rem] md:text-[12px] text-[14.5px] hover:bg-[#349105e1]">
                    Subscribe
                </button>
            </form>  
        </div>   
