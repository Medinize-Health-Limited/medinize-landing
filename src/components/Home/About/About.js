...
const About = () => {
    ...
    return (
        <div data-aos='slide-up' className="bg-image md:mt-28 mt-6 md:py-[3.4rem] py-[1.6rem]">
            ...
            <p className="text-center text-[#ffffffc9] flex md:w-[45%] w-[88%] mx-auto md:mt-10 mt-5 leading-[32px] text-[14.5px]">
            ...
            <button className="md:hidden block bg-[#358E07] text-white rounded-[5rem] px-6 md:py-3 py-[.8rem] md:text-[12px] mx-auto mt-6 w-[80%] hover:bg-[#349105e1]">
                <Link to={'/about'}>See more</Link>
            </button>
        </div>   
    )
