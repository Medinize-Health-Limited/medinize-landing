...
const Hero = () => {
    ...
    return (
        <div className="mx-[35px]">
            <div className="md:flex md:flex-row md:justify-between md:w-[90%] mx-auto mt-12">
                <div className="md:w-[50%] w-full md:mt-20">
                    <div className="">
                        <h1 className="md:text-[2.8rem] text-[1.8rem] text-[#1E1E1E] font-black md:leading-[52px]">Accelerate Your Health <br />
                    ...
                    <div className='md:space-x-4 mt-6 md:w-[70%] w-full md:flex md:flex-row md:justify-between'>
                        <button className="book bg-[#358E07] text-[13px] w-full md:w-[50%] w-full text-white py-3 px-6 rounded-[5rem]">Book an appointment</button>
                        <button className='access md:bg-[#fff] text-[13px] text-[#358E07] md:w-[50%] w-full py-3 px-6 md:rounded-[5rem]'>Access Community</button>
                    </div>
                </div>
